...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/vlkyrylenko/proxmox-helper/main/misc/copy-data/home-assistant-core-copy-data-home-assistant-container.sh)"
